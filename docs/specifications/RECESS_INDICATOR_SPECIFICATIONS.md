...
| `SEAM_CHANNEL_ARROW_MARGIN_MM` | 0.3 mm | Clear surface the tactile seam channel keeps from each end of the arrow chain (`SURFACE_DIMENSIONS_SPECIFICATIONS.md` §2.6) |
